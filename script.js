document.addEventListener('DOMContentLoaded', () => {
    ...
    let questions = [
        ...
        { image: './img/jpg17.png', question: '¿Como se llamaba la quinta de Cardales?', options: ['Sotomayor', 'San Jorge', 'Cordillera', 'Pehumayen'], correct: 3 },
        { image: './img/jpg18.png', question: '¿Como se llamaba esta panchería?', options: ['Pehuamar', 'Bristol', 'Lo de Tito', 'Pompeya'], correct: 1 },
